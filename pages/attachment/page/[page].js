...
import attachmentPageInitialPathsC605eResource from '../../../resources/attachment-page-initial-paths-c605e'
import attachmentPageInitialProps698d3Resource from '../../../resources/attachment-page-initial-props-698d3'
  ...
  return (
    <>
      <div className="attachment1-container">
        <Head>
          <title>Attachment - Speedy Major Ape</title>
          <meta property="og:title" content="Attachment - Speedy Major Ape" />
        </Head>
        <DataProvider
...
export async function getStaticPaths() {
  try {
    const response = await attachmentPageInitialPathsC605eResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialProps698d3Resource({
      ...context?.params,
    })
    if (!response) {
      return {
